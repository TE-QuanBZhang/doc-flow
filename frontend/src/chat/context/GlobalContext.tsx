...
export function GlobalProvider({ children }: { children: React.ReactNode }) {
  ...
  const startQuestionGen = (
    ...
    const token = typeof window !== "undefined" ? localStorage.getItem("doc_flow_token") || "" : "";
  ...
  const startMimicQuestionGen = (
    ...
    const token2 = typeof window !== "undefined" ? localStorage.getItem("doc_flow_token") || "" : "";
  ...
  const sendChatMessage = (message: string) => {
    ...
    const chatToken = typeof window !== "undefined" ? localStorage.getItem("doc_flow_token") || "" : "";
