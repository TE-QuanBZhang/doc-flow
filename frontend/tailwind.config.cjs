...
module.exports = {
  // Restrict Tailwind scanning to the sirchmunk-port chat module so the
  // existing doc-flow pages (hand-written index.css) are unaffected.
  content: ['./src/chat/**/*.{js,ts,jsx,tsx}'],
  darkMode: 'class',
  theme: {
    extend: {
      spacing: {
